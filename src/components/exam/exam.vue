...
<div class="exam" id="exam">
  <div class="exam-title exam-background-o">
  ...
  <div class="exam-testing">
    <div class="exam-test" id="exam-test1">
      ...
      <button id="text1_2" class="exam-button button-active-o" @click="userNumAdd" onclick="exam_text1_2()">18-24岁</button>
    ...
    <div class="exam-test" id="exam-test2">
      ...
      <button id="text2_2" class="exam-button button-active-o" @click="userNumAdd" onclick="exam_text2_2()">高中/中专</button>
    ...
    <div class="exam-test" id="exam-test3">
      ...
      <button id="text3_2" class="exam-button button-active-o" @click="userNumAdd" onclick="exam_text3_2()">1-2年</button>
    ...
    <div class="exam-test" id="exam-test4">
      ...
      <button id="text4_2" class="exam-button button-active-o" @click="userNumAdd" onclick="exam_text4_2()">找工作</button>
    ...
    <div class="exam-test" id="exam-test5">
      ...
      <button id="text5_2" class="exam-button button-active-o" @click="userNumAdd" onclick="exam_text5_2()">管理类</button>
    ...
    <div class="exam-input">
      <input class="exam-text" type="text" name="exam-text" id="exam-text" placeholder="请输入您的微信/QQ/电话" @input="button_active_o()">
